...
BLECharacteristic myCharacteristic("FFE1", BLEWrite | BLENotify, 0x10);  // parameterized constructor w/ usage: myCharacteristic(uuid, properties, value, valueSize)
...
void writeSensorData() {
  float sensor1, sensor2, sensor3 = 0;
  String strToPrint = " test ";  // string to print
...
void writeBMP280Str()
{
    ...
    { // check for valid data measurement
